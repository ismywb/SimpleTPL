...
function mysql_connect($server, $username, $password, $new_link = false, $client_flags = false) {
    return MySQLN::getInstance()->mysql_connect($server, $username, $password, $new_link, $client_flags);
}
// http://www.php.net/manual/en/function.mysql-connect.php
function mysql_pconnect($server, $username, $password, $new_link = false, $client_flags = false) {
    return MySQLN::getInstance()->mysql_pconnect($server, $username, $password, $new_link, $client_flags);
}
// http://www.php.net/manual/en/function.mysql-select-db.php
function mysql_select_db($database_name, $link = false) {
    return MySQLN::getInstance()->mysql_select_db($database_name, $link);
}
...
function mysql_data_seek($result, $row_number) {
    return MySQLN::getInstance()->mysql_data_seek($result, $row_number);
}
// http://www.php.net/manual/en/function.mysql-list-dbs.php
function mysql_list_dbs($link = false) {
    return MySQLN::getInstance()->mysql_list_dbs($link);
}
...
function mysql_db_name(&$result, $row, $field = 'Database') {
    return MySQLN::getInstance()->mysql_db_name($result, $row, $field);
}
...
function mysql_db_query($databaseName, $query, $link = false) {
    return MySQLN::getInstance()->mysql_db_query($databaseName, $query, $link);
}
// http://www.php.net/manual/en/function.mysql-drop-db.php
function mysql_drop_db($databaseName, $link = false) {
    return MySQLN::getInstance()->mysql_drop_db($databaseName, $link);
}
...
function mysql_unbuffered_query($query, $link = false) {
    return MySQLN::getInstance()->mysql_unbuffered_query($query, $link);
}
// http://www.php.net/manual/en/function.mysql-thread-id.php
function mysql_thread_id($link = false) {
    return MySQLN::getInstance()->mysql_thread_id($link);
}
// http://www.php.net/manual/en/function.mysql-list-tables.php
function mysql_list_tables($databaseName, $link = false) {
    return MySQLN::getInstance()->mysql_list_tables($databaseName, $link);
}
...
function mysql_fetch_lengths(&$result) {
    return MySQLN::getInstance()->mysql_fetch_lengths($result);
}
// http://www.php.net/manual/en/function.mysql-list-fields.php
function mysql_list_fields($databaseName, $tableName, $link = false) {
    return MySQLN::getInstance()->mysql_list_fields($databaseName, $tableName, $link);
}
...
function mysql_field_len(&$result, $fieldOffset = false) {
    return MySQLN::getInstance()->mysql_field_len($result, $fieldOffset);
}
...
function mysql_field_flags(&$result, $fieldOffset = false) {
    return MySQLN::getInstance()->mysql_field_flags($result, $fieldOffset);
}
...
function mysql_field_name(&$result, $fieldOffset = false) {
    return MySQLN::getInstance()->mysql_field_name($result, $fieldOffset);
}
...
function mysql_field_type(&$result, $fieldOffset = false) {
    return MySQLN::getInstance()->mysql_field_type($result, $fieldOffset);
}
...
function mysql_field_table(&$result, $fieldOffset = false) {
    return MySQLN::getInstance()->mysql_field_table($result, $fieldOffset);
}
...
function mysql_field_seek(&$result, $fieldOffset = false) {
    return MySQLN::getInstance()->mysql_field_seek($result, $fieldOffset);
}
// http://www.php.net/manual/en/function.mysql-fetch-field.php
function mysql_fetch_field(&$result, $fieldOffset = false) {
    return MySQLN::getInstance()->mysql_fetch_field($result, $fieldOffset);
}
// http://www.php.net/manual/en/function.mysql-num-fields.php
function mysql_num_fields($result) {
    return MySQLN::getInstance()->mysql_num_fields($result);
}
...
function mysql_num_rows($result) {
    return MySQLN::getInstance()->mysql_num_rows($result);
}
...
function mysql_info($link = false) {
    return MySQLN::getInstance()->mysql_info($link);
}
// Close all connections
function mysql_close_all() {
    return MySQLN::getInstance()->mysql_close_all();
}
// is_resource function over ride
function is_resource_custom($resource) {
    return MySQLN::getInstance()->is_resource($resource);
}
// get_resource_type_custom function over ride
function get_resource_type_custom($resource) {
    return MySQLN::getInstance()->get_resource_type($resource);
}
